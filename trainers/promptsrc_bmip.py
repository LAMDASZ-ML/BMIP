...
def load_clip_to_cpu(cfg, zero_shot_model=False):
    ...
    if not zero_shot_model:
        design_details = {"trainer": 'PROMPTSRC',
                          ...
                          "bitp_length": cfg.TRAINER.PROMPTSRC.N_CTX_TEXT,
...
class CustomCLIP(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        self.total_ctx = self.prompt_learner.n_ctx
    ...
    def forward(self, image, label=None):
        ...
        prompts, shared_ctx, deep_compound_prompts_text_t, deep_compound_prompts_vision_t,\
            prompts_v, shared_ctx_v, deep_compound_prompts_vision_v, deep_compound_prompts_text_v = self.prompt_learner()
