...
# done
bash scripts/promptsrc/base2new_train_promptsrc4.sh imagenet 1 cuda:0 ${CFG}
bash scripts/promptsrc/base2new_test_promptsrc4.sh imagenet 1 cuda:0 ${CFG}
bash scripts/promptsrc/base2new_train_promptsrc4.sh imagenet 2 cuda:0 ${CFG}
bash scripts/promptsrc/base2new_test_promptsrc4.sh imagenet 2 cuda:0 ${CFG}
bash scripts/promptsrc/base2new_train_promptsrc4.sh imagenet 3 cuda:0 ${CFG}
bash scripts/promptsrc/base2new_test_promptsrc4.sh imagenet 3 cuda:0 ${CFG}